...
***/
    //cashMoney>10 && cashMoney<=49   3   N/A N/A
          ...
          //string = "<br />";
            ...
            ***/
            ...
            /***/
            //$('#totalAmount').text('Kes ' + totalToSend.toFixed(2));
            $('#totalAmount').text('Sending Kes ' + cashMoney.toFixed(2) + ' to registered Mpesa User is Kes '+ registered.toFixed(2) + '.Withdraw From Agent is ' + agent + '.Withdraw From ATM is  ' + ATM  );
            /***/
            /***
            $('#totalAmount').text('Sending Kes ' + cashMoney.toFixed(2) + ' to registered Mpesa User is Kes '+ registered.toFixed(2) +
    ...
    //cashMoney==50 && cashMoney<=50 50 5 N/A 10
          ...
          $('#totalAmount').text('Sending Kes ' + cashMoney.toFixed(2) + ' to registered Mpesa User is Kes '+ registered.toFixed(2) +
           '. Send to unregistered Mpesa User is ' + unregistered +
           '. Withdraw From Agent is Kes ' + agent.toFixed(2) + '. Withdraw From ATM is  ' + ATM +
...
//cashMoney>45001    && cashMoney<=50000  110 N/A 275
    ...
    $('#totalAmount').text('Sending Kes ' + cashMoney.toFixed(2) + ' to registered Mpesa User is Kes '+ registered.toFixed(2) +
             '. Send to unregistered Mpesa User is  ' + unregistered +
             '. Withdraw From Agent is Kes ' + agent.toFixed(2) + '. Withdraw From ATM is  ' + ATM +
              '. Total To Send is Kes '+ totalToSend.toFixed(2) );
//$('p').text()
...
/***
    //testStart
    document.write("<br>"+payBill+"</br>");
    document.write("<br>"+ATM+"</br>");
    document.write("<br>"+agent+"</br>");
    document.write("<br>"+totalCost+"</br>");
    //document.write("<td id="+payBill+"></td>");
    //tagNam="ti"+loopNum.toString(10);
    //document.write("<td id="+tagNam+"><br>");
    //testEnd
    ***/

//test2Start
//document.write("<b> payBill </b> " +payBill+ "<br>";
//document.write(ATM+"<br>");
//document.write(agent+"<br>");
...
/***
     ...
     Excerpt From: Robin Nixon. “Learning PHP, MySQL, JavaScript, CSS & HTML5.” iBooks.
...
***/
            ...
            else
        {
            ...
            $('#totalAmount').text('Unknown Error.' );
